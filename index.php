                 ...
                 if (isset($_SESSION ['users'])) {
                  echo '<li class="btn__style"><a class="logoutstyle" href="out.php">Выйти</a></li>';
                     if ($_SESSION ['users']['isAdmin'] == 1) { 
                         echo '<li class="btn__style"><a class="logoutstyle" href="adminpanel.php">Редактор</a></li>';
                      }
                 }
              ?>
        ...
        <div class="catalog__order order ">
          <aside class="order__wrapper">
            <div class="order__wrap-title">
              ...
              <span class="order__count">3</span>
            </div>

            <div class="order__wrap-list">
              <ul class="order__list">
                <li class="order__item">
                  <img src="img/burger2.jpg" alt="Супер сырный" class="order__image">
                ...
                <li class="order__item">
                  <img src="img/hot-dog_1.jpg" alt="Хот-дог" class="order__image">

                  <div class="order__product">
                    <h3 class="order__product-title">Хот-дог</h3>

                    <p class="order__product-weight">350г</p>

                    <p class="order__product-price">320₽</p>
                  </div>
                ...
                <li class="order__item">
                  <img src="img/free_1.jpg" alt="Картофель фри" class="order__image">

                  <div class="order__product">
                    <h3 class="order__product-title">Картофель фри</h3>

                    <p class="order__product-weight">180г</p>

                    <p class="order__product-price">200₽</p>
                  </div>
              ...
              <div class="order__total">
                ...
                <p>
                  <span class="order__total-amount">1070</span>
                  <span class="currency">₽</span>
                </p>
              </div>

              <button class="order__submit" id="btndely">Оформить заказ</button>
          ...
          <ul class="catalog__list">
            ...
            <li class="catalog__item">
              <article class="product">
                ...
                <button class="product__add" id="myBtn">Добавить</button>
            ...
            <!-- <li class="catalog__item">
              <article class="product">
                <img class="product__image" src="img/burger2.jpg" alt="Супер сырный">
            ...
            <li class="catalog__item">
              <article class="product">
                <img class="product__image" src="img/burger4.jpg" alt="Сытный">
            ...
            <li class="catalog__item">
              <article class="product">
                <img class="product__image" src="img/burger1.jpg" alt="Тяжелый удар">
            ...
            <li class="catalog__item">
              <article class="product">
                <img class="product__image" src="img/burger3.jpg" alt="Тяжелый удар">
            ...
            <li class="catalog__item">
              <article class="product">
                <img class="product__image" src="img/burger5.jpg" alt="Тяжелый удар">
